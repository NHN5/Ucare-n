...
public class AddMedicineActivity extends AppCompatActivity {
    ...
    static final String[] typeList = {"Syrup", "Capsule", "Tablet","Injection","Saline"};
    ...
    private static final String[] unitListInjection = {"1", "2"};
    private static final String[] unitListSaline = {"1"};
    private static final String[] intakeList = {"15 mins before eating", "15 mins after eating", "1/2 hour before eating", "1/2 hour after eating"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if (parent.getItemAtPosition(position).toString() == "Syrup") {
                ...
                } else if (parent.getItemAtPosition(position).toString() == "Capsule") {
                    adapterunit = new ArrayAdapter<String>(AddMedicineActivity.this,
                ...
                } else if (parent.getItemAtPosition(position).toString() == "Injection") {
                    adapterunit = new ArrayAdapter<String>(AddMedicineActivity.this,
                            android.R.layout.simple_spinner_item, unitListInjection);
                    spinnerUnit.setAdapter(adapterunit);
                    try {
                        String compareUnit = schedule.getMedicineUnit();
                        if (compareUnit != null) {
                    ...
                    adapterunit = new ArrayAdapter<String>(AddMedicineActivity.this,
                            android.R.layout.simple_spinner_item, unitListSaline);
                    spinnerUnit.setAdapter(adapterunit);
                    try {
                        String compareUnit = schedule.getMedicineUnit();
                        if (compareUnit != null) {
...
//        Toast.makeText(this, "daysList"+daysList, Toast.LENGTH_SHORT).show();
    ...
    private void setEditData(Schedule schedule) {
        ...
        if (schedule != null) {
            ...
            List<String> tempList= schedule.getAlarm().getDays();

            if (tempList.contains("sat")&&tempList.contains("sun")&&tempList.contains("mon")&& tempList.contains("tue")&& tempList.contains("wed")&&tempList.contains("thu")&& tempList.contains("fri")){
                tvFri.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                tvThu.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                tvWed.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                tvTue.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                ...
                if (tempList.contains("sat")){
                    tvSat.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("sat");
                    sat="sat";
                }
                if (tempList.contains("sun")){
                    tvSun.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("sun");
                ...
                if (tempList.contains("mon")){
                    tvMon.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("mon");
                    mon="mon";

                }
                if (tempList.contains("tue")){
                    tvTue.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("tue");
                ...
                if (tempList.contains("wed")){
                    tvWed.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("wed");
                    wed="wed";

                }
                if (tempList.contains("thu")){
                    tvThu.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("thu");
                    thu="thu";

                }
                if (tempList.contains("fri")){
                    tvFri.setBackground(ContextCompat.getDrawable(AddMedicineActivity.this, R.drawable.bt_days_bg_selected));
                    daysList.add("fri");
                    fri="fri";
                }
